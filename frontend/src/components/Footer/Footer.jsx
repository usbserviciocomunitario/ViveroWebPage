        ...
        <div className="footer__content-bottom">
          <div className="footer__contact">
            ...
            <div className="footer__contact-item">
              <p>Ubicación:</p>
              <p>
                La Floresta, avenida San Carlos. Al lado del Colegio Santiago de
                León de Caracas. Municipio Chacao
              </p>
            </div>
          </div>
                ...
                return (
                  ...
                  >
                    <NavLink to={link.path}>
                      <IconPointFilled size={15} stroke={1} /> {link.name}
                    </NavLink>
                  </li>
                );
              })}
            ...
            <div className="footer__socials-content">
              {props.socials.map((social) => {
                ...
                if (social.name == "whatsapp")
                  icon = <IconBrandWhatsapp size={30} stroke={1} />;
